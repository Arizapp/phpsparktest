      ...
      <div class="card mb-3">
          ...
          <div class="row align-items-center">
            <div class="col">
              <h4 class="m-0">
                ...
                <small>
                  <i class="fas fa-angle-right mx-2"></i> Adicionar
                </small>
              </h4>
            </div>
        ...
        <div class="card-body">
          ...
          <div class="form-row">
            <div class="col">
              <div class="form-group">
                ...
                <textarea class="form-control" name="mapa" id="input-mapa"
          ...
          <div class="row justify-content-center">
            <div class="col-sm-6">
              <figure class="figure">
                <img src="" id="foto-preview" class="figure-img img-fluid rounded d-none"/>
              </figure>
            </div>
          </div>
        </div>
