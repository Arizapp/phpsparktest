 ...
 */
//dd($page->variables['search_cidade_icone']);
$db = db_connect();
        ...
        <div class="form-row">
            ...
            <div class="form-group">
              <div class="input-group">
                <div class="input-group-prepend">
                  <label class="input-group-text group-left" for="input-cidade"><img src="<?= img_uploaded_url($page->variables['search_cidade_icone']->value) ?>" alt=""></label>
                </div>
                <select name="cidade" id="input-cidade" class="form-control form-control-lg rounded-pill" onchange="Search.bairros()">
                  <option value="">Selecione uma Cidade</option>
                  <?php foreach ($cidades as $cidade) : ?>
                    <option value="<?= $cidade->id ?>" <?php if ($request->getGet('cidade') && $request->getGet('cidade') == $cidade->id) echo 'selected'; ?>>
                      <?= $cidade->name ?>
                    </option>
                  <?php endforeach; ?>
                </select>
          ...
          <div class="col-sm-6">
            <div class="form-group">
              <div class="input-group">
                <div class="input-group-prepend">
                  <label class="input-group-text group-left" for="input-bairro"><img src="<?= img_uploaded_url($page->variables['search_bairro_icone']->value) ?>" alt=""></label>
                </div>
        ...
        <div class="form-row">
          <div class="col-sm-6">
            <div class="form-group">
              <div class="input-group">
                <div class="input-group-prepend">
                  <label class="input-group-text group-left" for="input-quartos"><img src="<?= img_uploaded_url($page->variables['search_numero_de_quartos_icone']->value) ?>" alt=""></label>
                </div>
          ...
          <div class="col-sm-6">
            <div class="form-group">
              <div class="input-group">
                <div class="input-group-prepend">
                  <label class="input-group-text group-left" for="input-valor"><img src="<?= img_uploaded_url($page->variables['search_media_de_valor_icone']->value) ?>" alt=""></label>
                </div>
